  ...
  Widget build(BuildContext context) {
    return Obx(
      () => RawChip(
        ...
        label: Text(
          frame7ItemModelObj.button!.value,
          style: TextStyle(
        ...
        selected: (frame7ItemModelObj.isSelected?.value ?? false),
        backgroundColor: appTheme.deepPurple50,
        selectedColor: appTheme.deepPurple50,
        shape: (frame7ItemModelObj.isSelected?.value ?? false)
        ...
        onSelected: (value) {
          frame7ItemModelObj.isSelected!.value = value;
        },
      ),
    );
  }
