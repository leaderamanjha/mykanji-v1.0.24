import 'frame15_item_model.dart';import 'frame16_item_model.dart';import '../../../core/app_export.dart';/// This class defines the variables used in the [final_select_upcycle_screen],
/// and is typically used to hold data that is passed between different parts of the application.
class FinalSelectUpcycleModel {Rx<List<SelectionPopupModel>> dropdownItemList = Rx([SelectionPopupModel(id:1,title:"Item One",isSelected:true,),SelectionPopupModel(id:2,title:"Item Two",),SelectionPopupModel(id:3,title:"Item Three",)]);
...
Rx<List<Frame15ItemModel>> frame15ItemList = Rx(List.generate(2,(index) => Frame15ItemModel()));

Rx<List<Frame16ItemModel>> frame16ItemList = Rx(List.generate(2,(index) => Frame16ItemModel()));
